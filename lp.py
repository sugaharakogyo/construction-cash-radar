...
<div class="kcr-hero">
  <div class="kcr-hero-inner">
    ...
    <div class="kcr-hero-sub">
      ...
      あなたの会社の <b>資金ショート危険度</b> と <b>安全ライン不足額</b> を<br>
      その場で見える化します。
    </div>
...
<div class="kcr-grid-3">
  ...
  <div class="kcr-box">
    ...
    <div class="kcr-box-text">分かりやすいと回答</div>
  </div>
</div>
""")
...
<div class="kcr-grid-3">
  ...
  <div class="kcr-box">
    ...
    <div class="kcr-box-text">
      数字見せながら話せるから信用が上がった感じします。<br><br>
      融資もスムーズでした。
    </div>
  </div>
</div>
...
render("""
<div class="kcr-alert">
  <div class="kcr-alert-title">「まだ大丈夫」が一番危険です</div>
  <div class="kcr-alert-text">
    資金ショートは突然きます。<br><br>
